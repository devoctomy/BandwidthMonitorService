...
namespace BandwidthMonitorService.UnitTests.Services
{
    public class SamplerServiceTests
    {
        ...
        [Fact]
        public async void GivenListOfUrls_AndStoreSamples_WhenSample_ThenEachUrlSampled_AndEachSampleStored_AndResultsReturned()
        {
            // Arrange
            var mockAppSettings = new Mock<IAppSettings>();
            var mockFileDownloaderService = new Mock<IFileDownloaderService>();
        ...
        [Fact]
        public async void GivenListOfUrls_AndNotStoreSamples_WhenSample_ThenEachUrlSampled_AndResultsReturned()
        {
            // Arrange
            var mockAppSettings = new Mock<IAppSettings>();
            var mockFileDownloaderService = new Mock<IFileDownloaderService>();
            ...
            mockSamplesService.Verify(x => x.Create(
                It.Is<Sample>(y => urls.Contains(y.Url))), Times.Never);
        }
    }
}
